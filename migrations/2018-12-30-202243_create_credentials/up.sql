...
CREATE TABLE IF NOT EXISTS rublic.access_credentials (
	id CHAR(36) NOT NULL,
...
CREATE TABLE IF NOT EXISTS rublic.access_groups (
	id CHAR(36) NOT NULL,
	friendly_name VARCHAR(256) NOT NULL,
	CONSTRAINT access_groups_PK PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS rublic.credential_group_mappings (
	id CHAR(36) NOT NULL,
