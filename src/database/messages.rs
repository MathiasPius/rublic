...
actor_command! (GetCertificatesByDomainAndId(domain_id: String, id: i32) -> Vec<Certificate>);
actor_command! (GetCertificate(domain_id: String, id: i32, friendly_name: String) -> Certificate);